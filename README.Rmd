...
Note: This package was created as part of the [STAT545B Assignment 4](https://stat545.stat.ubc.ca/assignments/assignment-b4/) submission.
The corresponding website can be found under this link: [https://lamke07.github.io/stat545lamke07/index.html](https://lamke07.github.io/stat545lamke07/index.html).
...
often need to be written out quickly. The `stat545lamke07` package
...
Note: when using `devtools::check()`, you might need to have `qpdf` installed locally,
...
We have also included functions to create **causal** toy data sets, `causal_XTY_binary()` and `causal_XTY_multiple()`
